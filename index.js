...
function validatePassword() {
    ...
    if (password_field.value == 0) {
        ...
        error_password.innerHTML = "Introduzca al menos 8 caracteres";
        password_field.classList.add("invalid");
        password_field.classList.add("error_icon");
        return false;
    }
...
function validateForm() {
    if (validateConfirm() == true && validatePassword() == true && validateEmail() == true && validateName() == true){
